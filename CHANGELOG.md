...
### 0.0.10 (unreleased)
* Fix [issue 13](https://github.com/salsify/goldiloader/issues/13) - Handle associations in Rails 4.1.9+ that 
  use unscope now that the underlying Rails bug has been fixed.
